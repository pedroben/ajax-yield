...
var control_metadocumento_list = function(path) {
    //contexto privado

    var prefijo_div = "#metadocumento_list ";
    ...
    function enviarDatosUpdateForm(view, id) {
        ...
        if (resultado["status"] = "200") {
            mensaje = 'valores actualizados correctamente para el metadocumento con id=' + resultado["message"];
