 ...
 * @author al037431
 */
public class RepositorioGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<RepositorioBean> oRepositorios = oRepositorioDAO.getPage(rpp, page, alFilter, hmOrder);

            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oRepositorios);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
