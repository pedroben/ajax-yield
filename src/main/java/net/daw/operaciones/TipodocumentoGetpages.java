 ...
 * @author Jacobo
 */
public class TipodocumentoGetpages implements GenericOperation {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oTipodocumentoDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("TipodocumentoGetpagesJson: View Error: " + e.getMessage());
        }
    }
}
