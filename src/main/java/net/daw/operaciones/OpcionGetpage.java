 ...
 * @author rafa
 */
public class OpcionGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<OpcionBean> oOpcions = oOpcionDAO.getPage(rpp, page, alFilter, hmOrder);
            data = new Gson().toJson(oOpcions);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
