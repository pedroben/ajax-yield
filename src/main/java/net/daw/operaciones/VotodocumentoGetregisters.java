 ...
 * @author Jacobo
 */
public class VotodocumentoGetregisters implements GenericOperation {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oVotodocumentoDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("VotodocumentoGetregistersJson: View Error: " + e.getMessage());
        }
    }
}
