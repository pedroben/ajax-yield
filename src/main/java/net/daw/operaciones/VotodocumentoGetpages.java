 ...
 * @author Jacobo
 */
public class VotodocumentoGetpages implements GenericOperation {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            VotodocumentoDao oVotodocumentoDAO = new VotodocumentoDao(Conexion.getConection());
            int pages = oVotodocumentoDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("VotodocumentoGetpagesJson: View Error: " + e.getMessage());
        }
    }
}
