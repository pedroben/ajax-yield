 ...
 * @author Alvaro
 */
public class LenguajeGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<LenguajeBean> oLenguajes = oLenguajeDAO.getPage( rpp, page, alFilter,hmOrder );
            data = new Gson().toJson(oLenguajes);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
