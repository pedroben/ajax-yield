 ...
 * @author rafa
 */
public class CuestionarioGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<CuestionarioBean> oCuestionarios = oCuestionarioDAO.getPage( rpp, page, alFilter,hmOrder );
            
            GsonBuilder gsonBuilder = new GsonBuilder();
            gsonBuilder.setDateFormat("dd/MM/yyyy");
            Gson gson = gsonBuilder.create();
            data = gson.toJson(oCuestionarios);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
