 ...
 * @author al037721
 */
public class PreguntaGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<PreguntaBean> oPreguntas = oPreguntaDAO.getPage(rpp, page, alFilter, hmOrder);
            data = new Gson().toJson(oPreguntas);
            data = "{\"list\":" + data + "}";
