 ...
 * @author al037431
 */
public class MetadocumentoGetregisters implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oMetadocumentoDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("MetadocumentoGetregistersJson: View Error: " + e.getMessage());
        }
    }
}
