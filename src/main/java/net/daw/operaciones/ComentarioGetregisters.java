 ...
 * @author al037684
 */
public class ComentarioGetregisters implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oComentarioDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("ComentarioGetregistersJson: View Error: " + e.getMessage());
        }
    }
}
